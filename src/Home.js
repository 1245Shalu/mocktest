...
import {View, Text, StyleSheet,Image,TextInput, TouchableHighlight,FlatList} from 'react-native'
...
function Home() {
    ...
    useEffect(() => {
        axios.get('https://api.xentice.com/api/Hotels').then(response => {
        ...
        return(
            ...
            <TouchableHighlight style={styles.Buttonview}>
                ...
                <View style={styles.Lands}>
                    <FlatList data={hotels} keyExtractor={(item) => item?.id} horizontal renderItem={({item}) => {
                        return (
